...
urlpatterns = [
    ...
    path('scores/above_threshold/<float:threshold>/', get_scores_above_threshold, name='scores-above-threshold'),
    path('scores/below_threshold/<float:threshold>/', get_scores_below_threshold, name='scores-below-threshold'),
